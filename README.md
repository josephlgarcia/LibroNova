...
-- Insert sample data
INSERT INTO usuarios (nombre_usuario, contraseña, nombre_completo, rol) VALUES
('admin', 'admin123', 'System Administrator', 'ADMIN'),
('juan.perez', 'password123', 'Juan Pérez', 'USUARIO');

INSERT INTO libros (isbn, titulo, autor, stock) VALUES
('978-0134685991', 'Effective Java', 'Joshua Bloch', 5),
('978-0596009205', 'Head First Design Patterns', 'Eric Freeman', 3),
('978-0321356680', 'Effective Java Programming', 'Joshua Bloch', 2);
```
